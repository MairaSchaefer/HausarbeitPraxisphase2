...
\newcommand{\myTitle}{Vergleichende Analyse moderner Waldbrand-Frühwarnsysteme}
\newcommand{\myDegree}{Praxisphase 1}
...
\sisetup{
  range-phrase = --,    % Nutzt den Bis-Strich statt "bis"
  range-units  = single % Schreibt die Einheit nur einmal am Ende
}
...
\part{Fazit}\label{pt:diskussionFazit}
